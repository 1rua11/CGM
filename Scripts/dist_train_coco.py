...
from cgm.model_attn_aff import CGM
...
def train(cfg):
    ...
    if args.local_rank==0:
        ...
        #writer.add_graph(cgm, dummy_input)
    ...
    for n_iter in range(cfg.train.max_iters):
        ...
        cls, segs, attns, attn_pred = cgm(inputs, seg_detach=args.seg_detach)
        ...
        if (n_iter+1) % cfg.train.eval_iters == 0:
            ...
            cls_score, seg_score, cam_score, aff_score = validate(model=cgm, data_loader=val_loader, cfg=cfg)
            if args.local_rank==0:
